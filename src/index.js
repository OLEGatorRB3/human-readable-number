module.exports = function toReadable (number) {
    ...
    if(value[value.length - 2] == 'one' && value[value.length -1] == 'zero') {
        ...
        strValue = strValue.replace(/four.*/, 'fourty')
    }
    else if (value[value.length - 2] == 'four'){
        strValue = strValue.replace(/four/g, 'fourty')
    }
    else if (value[value.length - 2] == 'five' && value[value.length - 1] == 'zero'){
        strValue = strValue.replace(/five.*/, 'fifty')
    }
